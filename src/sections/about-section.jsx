...
/>
    ...
    <div className="relative shadow-2xl shadow-green-600/40 rounded-2xl overflow-hidden shrink-0">
        ...
        <div className="flex items-center gap-1 absolute bottom-8 left-8 bg-white p-4 rounded-xl">
            ...
            <p className="text-sm font-medium text-slate-800">Join our growing tech community</p>
        </div>
    </div>
    ...
    <div className="text-slate-600 max-w-xl">
        ...
        <p className="mt-4 text-sm">
            Whether you need school management software, campus solutions, water supply monitoring, or cooperative management tools, our software is designed to simplify complex processes and empower organizations.
        </p>
        <p className="mt-4 text-sm">
            From robust management systems to automation-ready workflows, Preface Technology helps you operate smarter, scale faster, and deliver better services.
        </p>
        <button className="flex items-center gap-2 mt-8 text-sm cursor-pointer hover:-translate-y-0.5 transition bg-gradient-to-r from-green-600 to-green-400 py-2 px-8 rounded-full text-white">
            <span>Read more</span>
